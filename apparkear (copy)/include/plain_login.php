...
<form> 
First name: <input type="text" onkeyup="showHint()">
</form>

						<div class="login_box">
							<form method="post"  onsubmit="showHint(this.value)">
							  <div class="form-group">
							  <div id="txtHint"></div>
							  ...
							  <button  name="submit" value="submit" style="margin: 0 auto; padding: 7px 30px;" class="btn btn-primary" onclick="showHint(this.value)">Submit</button>
							  </div>
						   </form>
...
function showHint(str) {
    ...
    if (str.length == 0) { 
        ...
        xmlhttp.open("GET", "ajax_plain_login.php?un=" + un +"pass=" + pass, true);
        xmlhttp.send();
    }
}
</script>

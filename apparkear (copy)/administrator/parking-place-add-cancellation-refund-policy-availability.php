...
if (isset($_POST['submit'])) {
    $_SESSION['parking_place']['cancellation_refund_availibility'] = [
        'refund_strict' => $_POST['refund_strict'],
        'refund_moderate' => $_POST['refund_moderate'],
        'refund_flexible' => $_POST['refund_flexible'],
        'google_calendar_sync' => $_POST['google_calendar_sync']
    ];

    header('location: parking-place-add-add-a-co-owner.php');
    exit();
}

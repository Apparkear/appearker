...
if (isset($_POST['submit'])) {
    $updateQry = mysqli_query($link, "UPDATE `parking_places` SET `fname`='{$_POST['fname']}', `lname`='{$_POST['lname']}', `email` = '{$_POST['email']}', `password` = '{$_POST['password']}', `home_work_phone` = '{$_POST['home_work_phone']}', `mobile_phone` = '{$_POST['mobile_phone']}', `alternate_phone` = '{$_POST['alternate_phone']}' WHERE `id` = '{$_REQUEST['id']}'");

    header('location: parking-place-edit-property-description.php?id='.$_REQUEST['id']);
    exit();
}
                            ...
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="fname" class="form-control" value="<?php echo $editObj->fname; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="lname" class="form-control" value="<?php echo $editObj->lname; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="email" name="email" class="form-control" value="<?php echo $editObj->email; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="password" name="password" class="form-control" value="<?php echo $editObj->password; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="home_work_phone" class="form-control" value="<?php echo $editObj->home_work_phone; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="mobile_phone" class="form-control" value="<?php echo $editObj->mobile_phone; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="alternate_phone" class="form-control" value="<?php echo $editObj->alternate_phone; ?>" required>
                                        </div>
                                    </div>
                                </div>

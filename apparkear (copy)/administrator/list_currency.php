...
if ((!isset($_REQUEST['submit'])) && (!isset($_REQUEST['action']))) {
    ...
    $sql = "select * from estejmam_currency  where id<>''";
...
if (isset($_GET['action']) && $_GET['action'] == 'delete') {
    $item_id = $_GET['cid'];
    mysql_query("delete from  estejmam_currency where id='" . $item_id . "'");
...
if (isset($_GET['action']) && $_GET['action'] == 'inactive') {
    $item_id = $_GET['cid'];
    mysql_query("update estejmam_currency set status='0' where id='" . $item_id . "'");
...
if (isset($_GET['action']) && $_GET['action'] == 'active') {
    $item_id = $_GET['cid'];
    mysql_query("update estejmam_currency set status='1' where id='" . $item_id . "'");
    $_SESSION['msg'] = message('updated successfully', 1);
    header('Location:list_currency.php');
    exit();
}
...
if (isset($_REQUEST['bulk_delete_submit'])) {
    ...
    foreach ($idArr as $id) {
        //echo "UPDATE `estejmam_currency` SET status='0' WHERE id=".$id;
        mysql_query("DELETE FROM`estejmam_currency` WHERE id=" . $id);
    }
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-edit"></i>List Currency
                            </div>
                            <!--<div class="tools">
    ...
    while ($row = mysql_fetch_object($record)) {
        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
        <?php echo stripslashes($row->country_name); ?>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <a  href="add_currency.php?id=<?php echo $row->id ?>&action=edit">
                                                        Edit </a>&nbsp;
...
<script type="text/javascript">
    function del(aa, bb)
    {
        ...
        if (a)
        {
            location.href = "list_currency.php?cid=" + aa + "&action=delete"
        }
    }

    function inactive(aa)
    {
        location.href = "list_currency.php?cid=" + aa + "&action=inactive"

    }
    function active(aa)
    {
        location.href = "list_currency.php?cid=" + aa + "&action=active";
    }

<?php 
include_once("controller/SubAdminController.php");
?>
<?php
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="#">Add Subadmin</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<span><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Subadmin</span>
					</li>
				</ul>
				...
				<div class="col-md-12">
					<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Subadmin
										</div>
										<div class="tools">
                                     ...
                                     <input type="hidden" name="action" value="<?php echo $_REQUEST['action'];?>" />
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" placeholder="Enter text" value="<?php echo $categoryRowset['admin_username'];?>" name="username" required>
													...
													<div class="col-md-4">
														<input type="email" class="form-control" placeholder="Enter text" value="<?php echo $categoryRowset['email'];?>" name="email" required>
													...
													<div class="col-md-4">
														<input type="text" class="form-control" placeholder="Enter text" value="<?php echo $categoryRowset['admin_password'];?>" name="password" required>

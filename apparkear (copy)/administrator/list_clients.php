...
if (isset($_GET['action']) && $_GET['action'] == 'delete') {
    $item_id = $_GET['cid'];
    mysqli_query($link, "delete from estejmam_clients where id='" . $item_id . "'");
...
<script language="javascript">
    function del(aa, bb)
    {
        ...
        if (a)
        {
            location.href = "list_clients.php?cid=" + aa + "&action=delete"
        }
    }
</script>
        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="list_banner.php">View Clients</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <!--<li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-edit"></i>List Clients
                            </div>
                            <!--<div class="tools">
                                        ...
                                        while ($row = mysqli_fetch_object($record)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-info btn-sm" onClick="window.location.href = 'add_clients.php?id=<?php echo $row->id ?>&action=edit'"><i class="fa fa-pencil"></i></a>

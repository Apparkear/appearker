...
if (isset($_REQUEST['submit'])) {
    ...
    $link1 = isset($_POST['link']) ? $_POST['link'] : '';

    $fields = array(

        'name' => mysqli_real_escape_string($link, $name),

        'link' => mysqli_real_escape_string($link, $link1),
    ...
    if ($_REQUEST['action'] == 'edit') {
        ...
        if (mysqli_query($link, $editQuery)) {
            ...
            $_SESSION['msg'] = "Error occured while updating Category";
...
if ($_REQUEST['action'] == 'edit') {
    ...
    $categoryRowset = mysqli_fetch_array(mysqli_query($link, "SELECT * FROM `estejmam_social` WHERE `id`='" . mysqli_real_escape_string($link, $_REQUEST['id']) . "'"));
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="add_social.php">Social Media</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<span><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Social Media</span>
					</li>
				</ul>
				...
				<div class="col-md-12">
					<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Social Media
										</div>
										<!--<div class="tools">
                                     ...
                                     <input type="hidden" name="action" value="<?php echo $_REQUEST['action']; ?>" />
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" placeholder="Enter text" readonly value="<?php echo $categoryRowset['name']; ?>" name="name" required>
											...
											<div class="form-actions fluid">
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
														...
														<button type="button" class="btn default" onclick="location.href='social.php'">Cancel</button>
													</div>
												</div>
											</div>
										</form>

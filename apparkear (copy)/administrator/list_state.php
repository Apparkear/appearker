...
?>
<?php
$sql = "select * from `states` where `country_id`='" . $_REQUEST['id'] . "' order by `name` ASC";
...
<script language="javascript">
    ...
    {
        location.href = "list_city.php?cid=" + aa + "&action=unfeature"

    }
    function feature(aa)
    {
        location.href = "list_city.php?cid=" + aa + "&action=feature";
    }
</script>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-edit"></i>State List
                            </div>
                            <div class="tools">
                                    ...
                                    if (mysql_num_rows($record) == 0) {
                                        ...
                                        while ($row = mysql_fetch_object($record)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-info btn-sm" onClick="window.location.href = 'list_city.php?id=<?php echo $row->id ?>'">List City</a>
                                                </td>

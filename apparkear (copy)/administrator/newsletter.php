...
if (isset($_REQUEST['submit'])) {
    ...
    if (!empty($_REQUEST['email'])) {
        ...
        $SQL = "SELECT * FROM `estejmam_newsletter`";
    ...
    foreach ($new_email as $email_id) {
        ...
        $SQL = "SELECT * FROM `estejmam_newsletters` where email='" . $email_id . "'";
        $result = mysql_query($SQL);
        ...
        $TemplateMessage.="<br>";
        $TemplateMessage.="<br>Welcome to Estajmam";
                ...
                <div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Newsletter
                            </div>
                            <div class="tools">
                            ...
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">              
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="checkbox" class="form-control" id="sel_user">&nbsp;Selected User
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select id="selectError" class="form-control" style="width:450px;" name="email[]" multiple disabled>
                                                <?php
                                                $SQL = "SELECT * FROM `estejmam_newsletters` where 1";
                                                $result = mysql_query($SQL);

...
$queryOnlineUser="select * from estejmam_user  where type=0 and 	is_loggedin=1 and id!=1 ";
    $resOnlineUser=mysql_query($queryOnlineUser); 
 $OnlineUsercount=mysql_num_rows($resOnlineUser);  
...
<!--									<div class="col-md-6">
							...
							<tbody>
                                                            <?php
							$sql="select * from estejmam_user  where type=0 and 	is_loggedin=1 and id!=1 ";
...
$count=1;
	...
	$img='../upload/userimage/'.$row->image;
	}
?>
							...
							<tr>
								...
								<?php
                              $_SESSION['chatuser'] = '1';
$_SESSION['chatuser_name'] = 'saroj'; 
                                
                                if($row->id !=$_SESSION['chatuser'])
						{
							...
							{
						?>
						<p><a style='color:green' href="javascript:void(0)" onclick="javascript:chatWith(<?php echo $row->id;?>,'<?php echo $row->fname;?>')">Chat with <?php echo $row->fname;?></a></p>

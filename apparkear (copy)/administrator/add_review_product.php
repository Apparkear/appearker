...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Review <small><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Review</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<!--<li>
						<a href="list_review_product.php">Edit Review</a>
						<i class="fa fa-angle-right"></i>
					</li>-->
					<li>
				...
				<div class="col-md-12">
					<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Edit Review
										</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="#" class="form-horizontal" method="post" action="add_review_product.php" enctype="multipart/form-data">
                                     ...
                                     <input type="hidden" name="action" value="<?php echo $_REQUEST['action'];?>" />
											...
											<div class="form-body">
												...
												<div class="form-group">
													...
													<div class="col-md-4">
														<textarea name="review" class="form-control" style="width:330px; height:100px;" required><?php echo $categoryRowset['review'];?></textarea>
													...
													<div class="col-md-4">
														<input type="text" class="form-control" placeholder="Enter text" value="<?php echo $categoryRowset['rate'];?>" name="rate" required>

...
if (isset($_POST['ExportCsv'])) {
    ...
    $today = date('Y-m-d');
    $sql = "select * from estejmam_booking  where accept_status	='1'  AND end_date >'" . $today . "'";
        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">View Complete Booking</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <!--<li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-edit"></i>List Complete Booking
                            </div>
                            <div class="tools">
                                    ...
                                    if (mysql_num_rows($record) == 0) {
                                        ...
                                        while ($row = mysql_fetch_object($record)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo stripslashes($row->prop_id); ?></td>

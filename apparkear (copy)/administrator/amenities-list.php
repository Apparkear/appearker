...
if (isset($_GET['action']) && $_GET['action'] == 'delete') {
    $item_id = $_GET['cid'];
    mysqli_query($link, "delete from `amenities` where id='" . $item_id . "'");
                                    ...
                                    if (mysqli_num_rows($record) == 0) {
                                        ...
                                        while ($row = mysqli_fetch_object($record)) {
                                                ...
                                                if ($row->image == '') {
                                                    ...
                                                    $img = '../upload/amenities/' . $row->image;
                                                }
                                            ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-info btn-sm" onClick="window.location.href = 'amenities-add.php?id=<?php echo $row->id ?>&action=edit'"><i class="fa fa-pencil"></i></a>

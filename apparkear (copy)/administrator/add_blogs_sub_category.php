<?php
include_once("controller/blogSubCategoryController.php");
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Blog Sub-Category <small><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Blog Sub-Category</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="list_blogs_sub_category.php">Blog Sub-Category</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<span><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Blog Sub-Category</span>
					</li>
				</ul>
				...
				<div class="col-md-12">
					<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Blog Sub-Category
										</div>
										<div class="tools">
                                      ...
                                      <div class="form-group">
													...
													<div class="col-md-4">
														<select class="form-control" name="cat_id" >
															...
															<?php 
															$SQL ="SELECT * FROM `estejmam_blogs_category`";
											...
											<div class="form-body">
												...
												<div class="form-group" style="display:none;">
													...
													<div class="col-md-2">
														<input type="file"  class=" btn blue" name="image"   ><?php if($categoryRowset['image']!=''){?><br><a href="../upload/category/<?php echo $categoryRowset['image'];?>" target="_blank">View</a><?php }?>

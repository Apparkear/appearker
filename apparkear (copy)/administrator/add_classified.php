<?php
include_once("controller/classifiedCategoryController.php");
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<span><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Classified Category</span>
					</li>
				</ul>
				...
				<div class="col-md-12">
					<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Classified Category
										</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="#" class="form-horizontal" method="post" action="add_classified.php" enctype="multipart/form-data">
										...
										<div class="col-md-4">
											<div class="input-group date date-picker" data-date-format="dd-mm-yyyy">
												...
												<div class="form-group">
													...
													<div class="col-md-2">
														<input type="file" name="image" class=" btn blue"  ><?php if($categoryRowset['image']!=''){?><br><a href="../upload/classified/<?php echo $categoryRowset['image'];?>" target="_blank">View</a><?php }?>

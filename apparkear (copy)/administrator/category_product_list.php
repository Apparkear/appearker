...
?>
<?php
$category_name=mysql_fetch_array(mysql_query("select * from `estejmam_category` where `id`='".$_REQUEST['id']."'"));
?>
...
<!--									<div class="col-md-6">
							...
							<tbody>
							<?php
                                                        $fetch_product=mysql_query("select * from estejmam_product  where `product_type`='P' and status='1' and `cat_id`='".$_REQUEST['id']."'");

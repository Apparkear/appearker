...
?>
<?php
$sql = "select * from `estejmam_erning_list`";
...
if (isset($_GET['action']) && $_GET['action'] == 'delete') {
    $item_id = $_GET['cid'];
    mysql_query("delete from estejmam_erning_list where id='" . $item_id . "'");
    //$_SESSION['msg']=message('deleted successfully',1);
    header('Location:list_earning_list.php');
    exit();
}
...
if (isset($_GET['action']) && $_GET['action'] == 'inactive') {
    $item_id = $_GET['cid'];
    mysql_query("update estejmam_erning_list set status='0' where id='" . $item_id . "'");
...
if (isset($_GET['action']) && $_GET['action'] == 'active') {
    $item_id = $_GET['cid'];
    mysql_query("update estejmam_erning_list set status='1' where id='" . $item_id . "'");
    //$_SESSION['msg']=message('updated successfully',1);
    header('Location:list_earning_list.php');
    exit();
}
...
<script language="javascript">
    function del(aa, bb)
    {
        ...
        if (a)
        {
            location.href = "list_earning_list.php?cid=" + aa + "&action=delete"
        }
    }

    function inactive(aa)
    {
        location.href = "list_earning_list.php?cid=" + aa + "&action=inactive"

    }
    function active(aa)
    {
        location.href = "list_earning_list.php?cid=" + aa + "&action=active";
    }
</script>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-edit"></i>Earning List
                            </div>
                            <div class="tools">
                                    ...
                                    if (mysql_num_rows($record) == 0) {
                                        ...
                                        $commissiontype = mysql_fetch_object(mysql_query("SELECT * FROM `estejmam_commision_type` WHERE `id`='" . $row->commision_type_id . "'"));
                                            ...
                                            <tr>
                                                ...
                                                <td>
												<a class="btn btn-info btn-sm" onClick="window.location.href = 'add_earning_list.php?id=<?php echo $row->id ?>&action=edit'"><i class="fa fa-pencil"></i></a>

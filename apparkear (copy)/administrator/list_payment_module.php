<?php
include_once("controller/PaymentModuleController.php");
?>
   ...
   function del(aa,bb)
   {
      ...
      if (a)
      {
        location.href="list_payment_module.php?cid="+ aa +"&action=delete"
      }  
   } 
   
function inactive(aa)
   { 
       location.href="list_payment_module.php?cid="+ aa +"&action=inactive"

   } 
   function active(aa)
   {
     location.href="list_payment_module.php?cid="+aa+"&action=active";
   } 
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>List Payment Module
							</div>
							<div class="tools">

...
if (isset($_REQUEST['submit'])) {
    ...
    if ($_REQUEST['action'] == 'edit') {
        ...
        $editQuery = "UPDATE `blog_post` SET " . implode(', ', $fieldsList)
        ...
        if ($_FILES['image']['tmp_name'] != '') {
            ...
            $image = mysql_query("UPDATE `blog_post` SET `image`='" . $img_name . "' WHERE `id` = '" . mysql_real_escape_string($_REQUEST['id']) . "'");
        }
        ...
        if (in_array($fileParts['extension'], $fileTypes)) {
            ...
            $addQuery = "INSERT INTO `blog_post` (`" . implode('`,`', array_keys($fields)) . "`)"
            ...
            if ($_FILES['image']['tmp_name'] != '') {
                ...
                $image = mysql_query("UPDATE `blog_post` SET `image`='" . $img_name . "' WHERE `id` = '" . $last_id . "'");
            }
            header('Location:list_post.php');
            exit();
        } else {
...
if ($_REQUEST['action'] == 'edit') {
    $categoryRowset = mysql_fetch_array(mysql_query("SELECT * FROM `blog_post` WHERE `id`='" . mysql_real_escape_string($_REQUEST['id']) . "'"));
}
                        ...
                        <div class="portlet-body form">
                            ...
                            <form class="form-horizontal" method="post" action="add_post.php" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                        ...
                                        <div class="col-md-4">
                                            <select class="form-control" name="blog_id">
                                                ...
                                                <?php while ($dataf = mysql_fetch_row($record1)) { ?>
                                                    <option value="<?php echo $dataf['0']; ?>" <?php if($dataf['0'] == $categoryRowset['blog_id']) {echo 'selected';}?>><?php echo $dataf['1']; ?></option>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Post Name</label>
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" placeholder="Enter text" value="<?php echo $categoryRowset['post_name']; ?>" name="post_name" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2">
                                            <input type="file" name="image" class=" btn blue"  ><?php if ($categoryRowset['image'] != '') { ?><br><a href="../upload/sitepost/<?php echo $categoryRowset['image']; ?>" target="_blank">View</a><?php } ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="ckeditor form-control" id="editor2" name="description" cols="100" rows="20"><?php echo stripslashes($categoryRowset['description']); ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="ckeditor form-control" id="editor1" name="ldescription" cols="100" rows="20"><?php echo stripslashes($categoryRowset['ldescription']); ?></textarea>
                                ...
                                <div class="form-actions fluid">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <button type="button" class="btn default" onclick="location.href = 'list_post.php'">Cancel</button>
                                        </div>
                                    </div>
                                </div>
                            </form>

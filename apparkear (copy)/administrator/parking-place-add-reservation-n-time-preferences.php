...
if (isset($_POST['submit'])) {
    $_SESSION['parking_place']['reservation_time_preference'] = [
        'advance_notice_time' => $_POST['advance_notice_time'],
        'preparation_time' => $_POST['preparation_time'],
        'booking_window' => $_POST['booking_window'],
        'max_period' => $_POST['max_period'],
        'min_period' => $_POST['min_period']
    ];

    header('location: parking-place-add-cancellation-refund-policy-availability.php');
    exit();
}

...
if (isset($_REQUEST['submit'])) {
    ...
    $featured_city_title = isset($_POST['featured_city_title']) ? $_POST['featured_city_title'] : '';
    $featured_city_description = isset($_POST['featured_city_description']) ? $_POST['featured_city_description'] : '';
    ...
    if (mysqli_query($link, $editQuery)) {
        ...
        header('Location:featured_city_manage_text.php');
        exit();
    }
}
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!-- BEGIN PAGE HEADER-->
            <h3 class="page-title">
                Featured City <small><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Featured City Text</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="list_product.php">Featured City Text</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <span><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Featured City Text</span>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Featured City Text
                            </div>
                            <!--<div class="tools">
                            ...
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="featured_city_title" value="<?php echo $categoryRowset['featured_city_title'] ?>" class="form-control" placeholder="Featured City Title.">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <textarea name="featured_city_description" class="form-control" placeholder="Featured City Description."><?php echo $categoryRowset['featured_city_description'] ?></textarea>

...
if (isset($_GET['action']) && $_GET['action'] == 'delete') {
    $item_id = $_GET['cid'];
    mysqli_query($link, "delete from home_section where id='" . $item_id . "'");
    ...
    if ($_REQUEST['action'] == 'edit') {
        ...
        if (mysqli_query($link, $editQuery)) {
            ...
            if ($_FILES['image']['tmp_name'] != '') {
                ...
                $image = mysqli_query($link, "UPDATE `home_section` SET `image`='" . $img_name . "' WHERE `id` = '" . mysql_real_escape_string($_REQUEST['id']) . "'");
            }
...
if ($_REQUEST['action'] == 'edit') {
    $categoryRowset = mysql_fetch_array(mysqli_query($link, "SELECT * FROM `home_section` WHERE `id`='" . mysql_real_escape_string($_REQUEST['id']) . "'"));
...
<script language="javascript">
    function del(aa, bb)
    {
        ...
        if (a)
        {
            location.href = "list_homesection.php?cid=" + aa + "&action=delete"
        }
    }
</script>
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="list_homesection.php">View Home Section</a>
						<i class="fa fa-angle-right"></i>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>List Home Section
							</div>
						</div>
        ...
        ?>
							...
							<tr>
								...
								<td>
									...
									<a class="btn btn-info btn-sm" onClick="window.location.href = 'add_homesection.php?id=<?php echo $row->id ?>&action=edit'"><i class="fa fa-pencil"></i></a>
...
function deleteConfirm(){
    var result = confirm("Are you sure to delete home section?");
    if(result){
        return true;
    }else{
        return false;

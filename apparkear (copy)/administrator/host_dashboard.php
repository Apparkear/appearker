                ...
                <div class="col-md-12 col-sm-6">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title line">
                            <div class="caption">
                                <i class="fa fa-bell-o"></i>Recent Renter
                            </div>
                            <!--                            <div class="tools">
                            ...
                            <div class="table-scrollable">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $queryOnlineVendor = "SELECT * from estejmam_user where 1 and `host_type`='1' order by `id` DESC";
                                        $resOnlineVendor = mysqli_query($link, $queryOnlineVendor);
                                        $numOnlineVendor = mysqli_num_rows($resOnlineVendor);
                                        while ($dataOnlineVendor = mysqli_fetch_assoc($resOnlineVendor)) {
                                            ...
                                            <tr>
                                                <th><?php echo $dataOnlineVendor['fname'] . ' ' . $dataOnlineVendor['lname']; ?> </th>
                                                <td><?php echo $status; ?></td>
                                                <td><?php echo $dataOnlineVendor['email']; ?></td>
                                                <td><img alt="" src="<?php echo $vendor_image; ?>" style="width:45px;height:45px;" class="img-responsive"/></td>
                                            </tr>
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title line">
                            <div class="caption">
                                <i class="fa fa-bell-o"></i>Renter Dashboard
                            </div>
                            <!--                            <div class="tools">
                                                            <a href="" class="collapse">
                                                            </a>
                        ...
                        <div class="portlet-body">
                            ...
                            <h4><?php echo $numHost ?> Renter registered in the site</h4>
                                        ...
                                        <div class="panel-body" style="padding-bottom: 0px;">
                                            <div id="pie-chart" class="pie-chart">
                                                <ul data-pie-id="pie_user_report">
                                                    <li data-value="<?php echo $num_acive_host; ?>">Total Active Renter (<?php echo $num_acive_host; ?>)</li>
                                                    <li data-value="<?php echo $num_inacive_host; ?>">Total Inactive Renter(<?php echo $num_inacive_host; ?>)</li>
                                                </ul>

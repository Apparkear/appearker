...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Product <small><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Sub Category</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<span><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Sub Category</span>
					</li>
				</ul>
				...
				<div class="col-md-12">
					<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Sub Category
										</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="#" class="form-horizontal" method="post" action="add_subcategory.php" enctype="multipart/form-data">
													...
													<div class="col-md-4">
														<select class="form-control" name="cat_id">
															<option value="">Select One</option>
																 <?php 
		 $SQL ="SELECT * FROM `estejmam_category`";

...
if (isset($_REQUEST['submit'])) {
    ...
    if ($_REQUEST['action'] == 'edit') {
        ...
        if ($_FILES['image']['tmp_name'] != '') {
            ...
            $img_name1 = $_REQUEST['hidimage'];
        }


        $editQuery1 = mysql_query("UPDATE `cities` SET `image`='" . $img_name1 . "' WHERE `id` = '" . mysql_real_escape_string($_REQUEST['id']) . "'");
...
if ($_REQUEST['action'] == 'edit') {
    $categoryRowset = mysql_fetch_array(mysql_query("SELECT * FROM `cities` WHERE `id`='" . mysql_real_escape_string($_REQUEST['id']) . "'"));
}
?>
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!-- BEGIN PAGE HEADER-->
            <h3 class="page-title">
                Property <small><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> City Image</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> City Image</span>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Add City Image
                            </div>
                            <!--<div class="tools">
                        ...
                        <div class="portlet-body form">
                            ...
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="hidimage" value="<?php echo $categoryRowset['image']; ?>" />
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">City Image</label>
                                    <div class="col-md-4">

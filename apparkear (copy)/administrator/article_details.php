...
$categoryRowset = mysql_fetch_array(mysql_query("SELECT * FROM `estejmam_artical` WHERE `id`='".mysql_real_escape_string($_REQUEST['id'])."'"));
$category = mysql_fetch_array(mysql_query("SELECT * FROM `estejmam_artical_category` WHERE `id`='".$categoryRowset['cat_id']."'"));
$subcategory = mysql_fetch_array(mysql_query("SELECT * FROM `estejmam_artical_subcategory` WHERE `id`='".$categoryRowset['sub_cat_id']."'"));
$store = mysql_fetch_array(mysql_query("SELECT * FROM `estejmam_store` WHERE `id`='".$categoryRowset['store_id']."'"));
$user = mysql_fetch_array(mysql_query("SELECT * FROM `estejmam_user` WHERE `id`='".$categoryRowset['user_id']."'"));
					...
					<div class="portlet box blue">
									...
									<div class="portlet-body form">
                                     ...
                                     <div class="form-body">
                                        ...
                                        <div class="form-body">
												<div class="form-group">
                                                                                                    <label class="col-md-3 control-label">Sub Category Name</label>										<div class="col-md-4">    
...
:</label>
                                        ...
                                        <div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">    
                                                <?php echo $categoryRowset['post_date'];?>
                                            ...
                                            <div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">        <?php 
                                                                                                      $moreimage1 = mysql_query("SELECT * FROM `estejmam_artical_image` WHERE `pro_id`='".mysql_real_escape_string($_REQUEST['id'])."'");

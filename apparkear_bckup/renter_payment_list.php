...
$get_booking = mysqli_query($link,"SELECT * FROM `estejmam_booking` ,`parking` WHERE `parking`.`id`=`estejmam_booking`.`prop_id` AND `estejmam_booking`.`user_id`=".$user_id." AND `payment_type`='stripe' AND `estejmam_booking`.`end_date`>='".date('Y-m-d')."'");
                    ...
                    <div class="my-properties">
                        ...
                        <div class="media pt-2 pb-2">
                            ...
                            <div class="rt-part ml-3 text-right">
                                <h5 class="mt-2">Order id: <?php echo $booking_row->order_id; ?></h5>
                                <!--<h4 class="book-his-price"><?php echo $booking_row->order_id; ?></h4>-->
                                <h4 class="book-his-price mb-4">Method : <?php echo $booking_row->payment_type; ?></h4>
                                                                    
                                <button type="button" class="btn btn-primary entry-dt">Exit date: <?php echo date('F j, Y',strtotime($booking_row->end_date)); ?></button>
                            </div>
                        </div>
                        <?php } ?> 

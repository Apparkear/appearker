...
$totalfee = $all_details->price + $all_details->service_charge;


$emailTemplateLandlord = mysql_fetch_array(mysql_query("SELECT * FROM estejmam_email_templt WHERE `id` =5"));

$emailTemplateTenant = mysql_fetch_array(mysql_query("SELECT * FROM estejmam_email_templt WHERE `id` =6"));

//----------- SMS TO Customer START -------------//
    ...
    //             'From' => "Roomarate",
    //             // 'From' => "+15807012787",
    //             'Body' => strip_tags($emailTemplateTenant['sms'])
    //         ));
...
$Subject = $emailTemplateTenant['subject'];
...
$prop_image = SITE_URL."upload/property/" . $image_details->image;
$prop_image = str_replace(" ","%20",$prop_image);
// $emailTemplate1 =mysql_query("SELECT * FROM estejmam_team LEFT JOIN estejmam_user ON estejmam_team.agent_id = estejmam_user.id WHERE `template_id`=6 ");
// while($tTeam=mysql_fetch_array($emailTemplate1))
// {
//     $email.=','.$tTeam['email'];
// }
$yeslink='https://www.roomarate.com/index.php?bookingid='.$latid.'&reply=yes';
$nolink='https://www.roomarate.com/index.php?bookingid='.$latid.'&reply=no';
$replaceTo=array(
                $emailTemplateTenant['subject'],
...
$landlordEmail = $user_details->email;
if($email) sendMailFromTemplate(6, $replaceFrom, $replaceTo, $email, $all_details->telephone);
...
//                 $latid
//                 ),
//             $emailTemplateTenant['description']
//         );
...
//----------- SMS TO LANDLORD START -------------//

$yeslink='https://www.roomarate.com/index.php?bookingid='.$latid.'&reply=yes';
$nolink='https://www.roomarate.com/index.php?bookingid='.$latid.'&reply=no';

$smsBodyL = str_replace(
            array(
                '[PROPERTYID]',
                '[PROPERTYADDRESS]',
                '[MOVEIN]',
            ...
            str_replace('&nbsp;',' ',strip_tags($emailTemplateLandlord['sms']))
        );
...
//----------- MAIL TO LANDLORD START -------------//



$Subject = $emailTemplateLandlord['subject'];

$from = new DateTime($all_details->dob);
$to   = new DateTime('today');
$tage = $from->diff($to)->y;

// $emailTemplate2 =mysql_query("SELECT * FROM estejmam_team LEFT JOIN estejmam_user ON estejmam_team.agent_id = estejmam_user.id WHERE `template_id`=5");
// while($lTeam=mysql_fetch_array($emailTemplate2))
// {
//     $landlordEmail.=','.$lTeam['email'];
// }
...
if($landlordEmail) sendMailFromTemplate(5, $replaceFrom, $replaceTo, $landlordEmail, $user_details->phone);

// $detail41 = str_replace(
//             array(
//                 '[MAILHEADER]',
//                 '[LANDLORD]',
//                 '[PropertyName]',
...
//                 $nolink
//                 ),
//             $emailTemplateLandlord['description']
//         );


// $TemplateMessage = $detail41;
// $mail1 = new PHPMailer;
// $mail1->FromName = "The Roomarate Team";
// $mail1->From = "info@roomarate.com";
// $mail1->Subject = $Subject;
...
// $mail1->AltBody = stripslashes($TemplateMessage);
// $mail1->IsHTML(true);
// $mail1->AddAddress($landlordEmail, "roomarate.com"); //info@salaryleak.com
// $mail1->Send();

//----------- MAIL TO LANDLORD END -------------//
...
//----------- SMS TO ADMIN START -------------//
        ...
        //     $phone = $all_details->telephone;
        //     $sender['user_first_name'] = "Roomarate";
        //     $adminNum=array("+447841478505","+34662343108","+447476871134");

        //     foreach ($adminNum as $Phone) {
                
        //         $client->account->messages->create(array(
        //             'To' =>$Phone,
        //             // 'To' =>$adminSetting->phone_no,
        //             'From' => "+15807012787",
        //             'Body' => $smsBodyL
        //         ));
        //     }
...
$adminEmail = $adminSetting->email;

$Subject = "Roomarate - Booking request " . $prop_details->unique_prop_id . " has been received";

//$detail42 = "";


/*$TemplateMessage = $detail42;
$mail1 = new PHPMailer;
$mail1->FromName = "The Roomarate Team";
$mail1->From = "info@roomarate.com";
$mail1->Subject = $Subject;
...
$mail1->AltBody = stripslashes($TemplateMessage);
$mail1->IsHTML(true);
$mail1->AddAddress($adminEmail, "roomarate.com"); //info@salaryleak.com
$mail1->Send();*/

...
if (isset($_POST['submit'])) {
    $updateQry = mysqli_query($link, "UPDATE `parking_places` SET `refund_strict`='{$_POST['refund_strict']}', `refund_moderate`='{$_POST['refund_moderate']}', `refund_flexible` = '{$_POST['refund_flexible']}', `google_calendar_sync` = '{$_POST['google_calendar_sync']}'  WHERE `id` = '{$_REQUEST['id']}'");

    header('location: parking-place-edit-add-a-co-owner.php?id='.$_REQUEST['id']);
    exit();
}
                ...
                <div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Cancellation/Refund Policy/Availability
                            </div>
                        </div>
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="refund_strict" value="1"> Strict: 50% Refund up until 2 weeks prior to arrival
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="refund_moderate" value="1"> Moderate: Full Refund until 1 weeks prior to arrival
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="refund_flexible" value="1"> Flexible: Full Refund until 2 days prior to arrival
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="google_calendar_sync" value="1"> Calendar sync - Google calendar
                                                </label>
                                            </div>
                                        </div>
                                    </div>

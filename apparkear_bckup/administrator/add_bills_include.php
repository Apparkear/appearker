...
if (isset($_GET['action']) && $_GET['action'] == 'delete') {
    $item_id = $_GET['cid'];
    mysqli_query($link, "delete from  estejmam_bills_include where id='" . $item_id . "'");
...
if (isset($_GET['action']) && $_GET['action'] == 'inactive') {
    $item_id = $_GET['cid'];
    mysqli_query($link, "update estejmam_bills_include set status='0' where id='" . $item_id . "'");
...
if (isset($_GET['action']) && $_GET['action'] == 'active') {
    $item_id = $_GET['cid'];
    mysqli_query($link, "update estejmam_bills_include set status='1' where id='" . $item_id . "'");
    $_SESSION['msg'] = message('updated successfully', 1);
    header('Location:list_bills_include.php');
    exit();
}
...
if ((!isset($_REQUEST['submit'])) && (!isset($_REQUEST['action']))) {
    ...
    $sql = "select * from estejmam_bills_include  where 1";
...
if (isset($_REQUEST['submit'])) {
    ...
    if ($_REQUEST['action'] == 'edit') {
        $editQuery = "UPDATE `estejmam_bills_include` SET " . implode(', ', $fieldsList)
                . " WHERE `id` = '" . mysqli_real_escape_string($link, $_REQUEST['id']) . "'";

        if (mysqli_query($link, $editQuery)) {

            if ($_FILES['image']['tmp_name'] != '') {
                $target_path = "../upload/bills_image/";
                ...
                $image = mysqli_query($link, "UPDATE `estejmam_bills_include` SET `image`='" . $img_name . "',`filter_img`='". $img_name ."'  WHERE `id` = '" . mysqli_real_escape_string($link, $_REQUEST['id']) . "'");
            }
        ...
        $addQuery = "INSERT INTO `estejmam_bills_include` (`" . implode('`,`', array_keys($fields)) . "`)"
        ...
        if ($_FILES['image']['tmp_name'] != '') {
            ...
            $image = mysqli_query($link, "UPDATE `estejmam_bills_include` SET `image`='" . $img_name . "',`filter_img`='". $img_name ."' WHERE `id` = '" . $last_id . "'");
        }
...
if ($_REQUEST['action'] == 'edit') {
    $categoryRowset = mysqli_fetch_array(mysqli_query($link, "SELECT * FROM `estejmam_bills_include` WHERE `id`='" . mysqli_real_escape_string($link, $_REQUEST['id']) . "'"));
}
?>
                ...
                <div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Billing Includes
                            </div>
                            <div class="tools">
                            ...
                            <form action="#" class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Bills Include Name</label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Bills Include Image</label>
                                        <div class="col-md-4">
                                    ...
                                    if ($_REQUEST['action'] == 'edit') {
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <a href="../upload/bills_image/<?php echo $categoryRowset['image']; ?>" target="_blank"><img src="../upload/bills_image/<?php echo $categoryRowset['image']; ?>" style="width:150px;"></a>
                                            </div>
                                        </div>
                                        <?php
                                    }

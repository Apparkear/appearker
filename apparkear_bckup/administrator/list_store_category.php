<?php
include_once("controller/storeCategoryController.php");
...
<script language="javascript">
   function del(aa,bb)
   {
      ...
      if (a)
      {
        location.href="list_store_category.php?cid="+ aa +"&action=delete"
      }  
   } 
   
function inactive(aa)
   { 
       location.href="list_store_category.php?cid="+ aa +"&action=inactive"

   } 
   function active(aa)
   {
     location.href="list_store_category.php?cid="+aa+"&action=active";
   } 
...
<!--									<div class="col-md-6">
							...
							<tbody>
							<?php
                                                $sql="select * from estejmam_store_category where 1";
...
?>
							...
							<tr>
								...
								<td>
									<a onClick="window.location.href='add_store_category.php?id=<?php echo $row->id ?>&action=edit'">Edit</a>
								</td>
                                                                <td>

...
if (isset($_REQUEST['submit'])) {
    ...
    if ($_REQUEST['action'] == 'edit') {
        $editQuery = "UPDATE `estejmam_commision_type` SET " . implode(', ', $fieldsList)
        ...
        $addQuery = "INSERT INTO `estejmam_commision_type` (`" . implode('`,`', array_keys($fields)) . "`)"
...
if ($_REQUEST['action'] == 'edit') {
    $categoryRowset = mysql_fetch_array(mysql_query("SELECT * FROM `estejmam_commision_type` WHERE `id`='" . mysql_real_escape_string($_REQUEST['id']) . "'"));
}
?>
        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">Add Commission Type</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <span><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Commission Type</span>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Commission Type
                            </div>
                            <!--<div class="tools">
                            ...
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" placeholder="Enter Type" value="<?php echo $categoryRowset['name']; ?>" name="name" required>
                                        </div>
                                    </div>
                                ...
                                <div class="form-actions fluid">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <button type="button" class="btn default" onclick="location.href='list_commission_type.php'">Cancel</button>

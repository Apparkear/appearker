...
if (isset($_GET['action']) && $_GET['action'] == 'notverify') {
    $item_id = $_GET['cid'];
    mysql_query("update estejmam_user set is_verifyed='0' where id='" . $item_id . "'");
    //$_SESSION['msg']=message('updated successfully',1);
    header('Location:search_user.php');
    exit();
}
if (isset($_GET['action']) && $_GET['action'] == 'verify') {
    $item_id = $_GET['cid'];
    mysql_query("update estejmam_user set is_verifyed='1' where id='" . $item_id . "'");
    //$_SESSION['msg']=message('updated successfully',1);
    header('Location:search_user.php');
    exit();
}
...
if (isset($_GET['action']) && $_GET['action'] == 'hostinactive') {
    $item_id = $_GET['cid'];
    mysql_query("update estejmam_user set host_type='0' where id='" . $item_id . "'");
    //$_SESSION['msg']=message('updated successfully',1);
    header('Location:search_user.php');
    exit();
}
if (isset($_GET['action']) && $_GET['action'] == 'hostactive') {
    $item_id = $_GET['cid'];
    mysql_query("update estejmam_user set host_type='1' where id='" . $item_id . "'");
    //$_SESSION['msg']=message('updated successfully',1);
    header('Location:search_user.php');
    exit();
}

if (isset($_GET['action']) && $_GET['action'] == 'hostdisapproved') {
    $item_id = $_GET['cid'];
    mysql_query("update estejmam_user set is_approved='0' where id='" . $item_id . "'");
    //$_SESSION['msg']=message('updated successfully',1);
    header('Location:search_user.php');
    exit();
}
if (isset($_GET['action']) && $_GET['action'] == 'hostapproved') {
    $item_id = $_GET['cid'];
    mysql_query("update estejmam_user set is_approved='1' where id='" . $item_id . "'");
    //$_SESSION['msg']=message('updated successfully',1);
    header('Location:search_user.php');
    exit();
}
...
if (isset($_POST['ExportCsv'])) {
    ...
    $sql = "select * from estejmam_user  where id<>'' AND `tenants_type`='1'";
...
?>
<?php
$sql = "select * from estejmam_user  where id<>'' AND `type`='2' AND `host_type`='1' ";
...
<script language="javascript">
    ...
    {
        location.href = "search_user.php?cid=" + aa + "&action=verify";
    }


    function hostinactive(aa)
    {
        location.href = "search_user.php?cid=" + aa + "&action=hostinactive"

    }
    function hostactive(aa)
    {
        location.href = "search_user.php?cid=" + aa + "&action=hostactive";
    }

    function hostdisapproved(aa)
    {
        location.href = "search_user.php?cid=" + aa + "&action=hostdisapproved"

    }
    function hostapproved(aa)
    {
        location.href = "search_user.php?cid=" + aa + "&action=hostapproved";
    }
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($row->is_approved == '0') { ?>
                                                        <a class="btn btn-danger"  onClick="javascript:hostapproved('<?php echo $row->id; ?>');">Disapproved</a>
                                                    <?php } else { ?>
                                                        <a class="btn btn-success"  onClick="javascript:hostdisapproved('<?php echo $row->id; ?>');">Approved</a>
                                                    <?php } ?>
                                                </td>

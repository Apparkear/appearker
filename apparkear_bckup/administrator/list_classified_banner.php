<?php
include_once("controller/bannerClassifiedController.php");
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="#">View Classified Banner</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<!--<li>
...
<!--									<div class="col-md-6">
							...
							<tbody>
							<?php
                                                    // $sql="select * from estejmam_classified_banner   where id<>''";
...
?>
							...
							<tr>
								...
								<td>
									<a  href="add_classified_banner.php?id=<?php echo $row->id ?>&action=edit">
									Edit </a>
								</td>
								<!--<td>

...
if (isset($_GET['action']) && $_GET['action'] == 'delete') {
    $item_id = $_GET['cid'];
    mysql_query("delete from estejmam_our_value where id='" . $item_id . "'");
...
<script language="javascript">
    function del(aa, bb)
    {
        ...
        if (a)
        {
            location.href = "list_our_value.php?cid=" + aa + "&action=delete"
        }
    }
</script>
        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="list_banner.php">View Our Value Section</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <!--<li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-edit"></i>List Our Value Section
                            </div>
                            <!--<div class="tools">
                                        ...
                                        while ($row = mysql_fetch_object($record)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-info btn-sm" onClick="window.location.href = 'add_our_value.php?id=<?php echo $row->id ?>&action=edit'"><i class="fa fa-pencil"></i></a>

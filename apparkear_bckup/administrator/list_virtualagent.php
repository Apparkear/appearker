...
if((!isset($_REQUEST['submit'])) && (!isset($_REQUEST['action']))){
	...
	$sql="select * from estejmam_user  where type ='2' AND host_type ='0'";
...
if(isset($_REQUEST['bulk_delete_submit'])){
        ...
        $_SESSION['success_msg'] = 'Virtual agent have been deleted successfully.';
...
<script language="javascript">
    function del(aa, bb)
    {
        ...
        if (a)
        {
            location.href = "list_virtualagent.php?cid=" + aa + "&action=delete"
        }
    }
</script>
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="list_banner.php">View Virtual Agent</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<!--<li>
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>List Virtual Agent
							</div>
							<!--<div class="tools">
										...
										else
										{
											...
											<tr>
												...
												<td>
													...
													<a class="btn btn-info btn-sm" onClick="window.location.href = 'add_virtualagent.php?id=<?php echo $row->id ?>&action=edit'"><i class="fa fa-pencil"></i></a>

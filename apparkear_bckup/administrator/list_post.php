		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="list_banner.php">View Blog</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<!--<li>
									...
									<?php
										...
										else
										{
											...
											<tr>
												...
												<td>
													<?php echo stripslashes($row->post_name);?>
												</td>
												...
												<td>
													...
													<a class="btn btn-info btn-sm" onClick="window.location.href = 'add_post.php?id=<?php echo $row->id ?>&action=edit'"><i class="fa fa-pencil"></i></a>

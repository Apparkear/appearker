<?php
include_once("controller/dealProductController.php");
?>
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>Products in deal
							</div>
							<div class="tools">
...
<!--									<div class="col-md-6">
							...
							<tbody>
							<?php
                                                        $fetch_product=mysql_query("select * from estejmam_product  where `product_type`='P'");
...
{
if(mysql_num_rows(mysql_query("SELECT * FROM `estejmam_moreimage` WHERE `pro_id`='".$product['id']."'"))){
...
$image_link='../upload/no.png';
							...
							<tr>
								...
								<td>
									<a  href="details_product.php?id=<?php echo $product['id'] ?>&action=details'">
									Details </a>
								</td>
								<!--<td>

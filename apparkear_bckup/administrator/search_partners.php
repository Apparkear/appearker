...
if (isset($_GET['action']) && $_GET['action'] == 'delete') {
    ...
    mysqli_query($link, "delete from  estejmam_partners where id='" . $item_id . "'");
...
if (isset($_POST['ExportCsv'])) {
    ...
    $sql = "select * from estejmam_partners  where id<>'' AND `tenants_type`='1'";
...
?>
<?php
$sql = "select * from estejmam_partners";
...
if (isset($_REQUEST['bulk_delete_submit'])) {
    ...
    header("Location:search_partners.php");
}
?>
...
<script language="javascript">
    function del(aa, bb)
    {
        ...
        if (a)
        {
            location.href = "search_partners.php?cid=" + aa + "&action=delete"
        }
    }

    function inactive(aa)
    {
        location.href = "search_partners.php?cid=" + aa + "&action=inactive"

    }
    function active(aa)
    {
        location.href = "search_partners.php?cid=" + aa + "&action=active";
    }

    function inactiveVar(aa)
    {
        location.href = "search_partners.php?cid=" + aa + "&action=notverify"

    }
    function activeVar(aa)
    {
        location.href = "search_partners.php?cid=" + aa + "&action=verify";
    }


    function hostinactive(aa)
    {
        location.href = "search_partners.php?cid=" + aa + "&action=hostinactive"

    }
    function hostactive(aa)
    {
        location.href = "search_partners.php?cid=" + aa + "&action=hostactive";
    }
...
//$record=mysqli_query($link, $sql);
                                    ...
                                    if (mysqli_num_rows($record) == 0) {
                                        ...
                                        while ($row = mysqli_fetch_object($record)) {
                                            ...
                                            if ($row->image != '') {
                                                $image_link = '../upload/clients/' . $row->logo;
                                            } else {
                                            ...
                                            <tr>
                                               ...
                                               <!--  <td>
                                                ...
                                                <td>
                                                    <a class="btn btn-info btn-sm" onClick="window.location.href = 'add_partners.php?id=<?php echo $row->id ?>&action=edit'"><i class="fa fa-pencil"></i></a>

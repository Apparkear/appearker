...
if (isset($_GET['action']) && $_GET['action'] == 'delete') {
    $item_id = $_GET['cid'];
    mysql_query("delete from estejmam_add_team_member where id='" . $item_id . "'");
...
<script language="javascript">
    function del(aa, bb)
    {
        ...
        if (a)
        {
            location.href = "list_team_member.php?cid=" + aa + "&action=delete"
        }
    }
</script>
        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="list_banner.php">View Team Members</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <!--<li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-edit"></i>List Team Members
                            </div>
                            <!--<div class="tools">
                                    ...
                                    if (mysql_num_rows($record) == 0) {
                                        ...
                                        while ($row = mysql_fetch_object($record)) {
                                            if ($row->image == '') {
                                                ...
                                                $img = '../upload/teammember/' . $row->image;
                                            }
                                            ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-info btn-sm" onClick="window.location.href = 'add_team_member.php?id=<?php echo $row->id ?>&action=edit'"><i class="fa fa-pencil"></i></a>

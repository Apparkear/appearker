...
<script language="javascript">
   function del(aa,bb)
   {
      ...
      if (a)
      {
        location.href="list_user.php?cid="+ aa +"&action=delete"
      }  
   } 
...
<!--									<div class="col-md-6">
							...
							<tbody>
							<?php
                                                     //$sql="select * from estejmam_tbladmin  where id!= 1 order by id desc";
							...
							<tr>
								...
								<td>
									...
									<a onClick="javascript:del('<?php echo $row->id; ?>')">Delete</a>
                                                                ...
                                                                <td>
									<a onClick="window.location.href='privilege.php?id=<?php echo $row->id ?>&action=privilege&bk=4'">Set Privilege</a>
								</td>
							</tr>
                                                       <?php
                                                        }

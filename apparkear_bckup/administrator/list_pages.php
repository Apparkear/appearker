...
if (isset($_GET['action']) && $_GET['action'] == 'delete') {
    $item_id = $_GET['cid'];
    mysqli_query($link, "delete from footer_pages where id='" . $item_id . "'");
...
if ($_REQUEST['action'] == 'edit') {
    $categoryRowset = mysql_fetch_array(mysqli_query($link, "SELECT * FROM `footer_pages` WHERE `id`='" . mysql_real_escape_string($_REQUEST['id']) . "'"));
...
<script language="javascript">
    function del(aa, bb)
    {
        ...
        if (a)
        {
            location.href = "list_pages.php?cid=" + aa + "&action=delete"
        }
    }
</script>
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="list_pages.php">View Pages</a>
						<i class="fa fa-angle-right"></i>
					</li>
				</ul>
        ...
        ?>
							...
							<!-- 	<td>
								...
								<td>
									...
									<a class="btn btn-info btn-sm" onClick="window.location.href = 'add_pages.php?id=<?php echo $row->id ?>&action=edit'"><i class="fa fa-pencil"></i></a>

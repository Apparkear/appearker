...
if (isset($_REQUEST['submit'])) {
    ...
    $our_value_manage_text = isset($_POST['our_value_manage_text']) ? $_POST['our_value_manage_text'] : '';
    ...
    if (mysqli_query($link, $editQuery)) {
        ...
        header('Location:our_value_manage_text.php');
        exit();
    }
}
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!-- BEGIN PAGE HEADER-->
            <h3 class="page-title">
                Our Value Text <small><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Our Value Text</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Our Value Text</span>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Our Value Text
                            </div>
                            <!--<div class="tools">
                            ...
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="our_value_manage_text" value="<?php echo $categoryRowset['our_value_manage_text'] ?>" class="form-control" placeholder="Our Value Manage Text.">

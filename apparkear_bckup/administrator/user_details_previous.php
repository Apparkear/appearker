					...
					<div class="portlet box blue">
									...
									<div class="portlet-body form">
                                     ...
                                     <input type="hidden" name="action" value="<?php echo $_REQUEST['action'];?>" />
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">  <?php echo $categoryRowset['fname'];?> <?php echo $categoryRowset['lname'];?>
                                     ...
                                     <div class="form-body">
                                          ...
                                          <span class="input-xlarge"><img src="../upload/userimage/<?php echo $categoryRowset['image'] ;?>" height="70" width="70" style="border:1px solid #666666" /></span>
                                              <?php
                                              }
 else {
     ?>
											...
											<div class="form-actions fluid">
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
														...
														<button type="reset" class="btn blue" onClick="window.location.href='search_user.php'">Back</button>
													</div>
												</div>
											</div>
										</form>

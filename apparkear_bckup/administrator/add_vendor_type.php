...
if(isset($_REQUEST['submit']))
{
	...
	$fields = array(
		'fname' => mysql_real_escape_string($fname),
            ...
            'company_name' => mysql_real_escape_string($cname),
	 ...
	 else
	 {
	  ...
	  $addQuery = "INSERT INTO `estejmam_user` (`" . implode('`,`', array_keys($fields)) . "`)"
		...
		$image =mysql_query("UPDATE `estejmam_directory` SET `image`='".$img_name."' WHERE `id` = '" . $last_id . "'");
		}
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<span><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Vendor</span>
					</li>
				</ul>
				...
				<div class="col-md-12">
					<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Vendor
										</div>
										<div class="tools">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="#" class="form-horizontal" method="post" action="add_vendor_type.php" enctype="multipart/form-data">
                                     ...
                                     <input type="hidden" name="action" value="<?php echo $_REQUEST['action'];?>" />
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" placeholder="Enter text"  value="<?php echo $categoryRowset['fname'];?>" name="fname" required>
													...
													<div class="col-md-4">
														<input type="text" class="form-control" placeholder="Enter text" value="<?php echo $categoryRowset['phone'];?>" name="phone" required>
													...
													<div class="col-md-4">
														<input type="text" class="form-control" placeholder="Enter text" value="<?php echo $categoryRowset['address'];?>" name="address" required>
									...
									<div class="form-group">
													...
													<div class="col-md-4">
														<input type="text" class="form-control" placeholder="Enter text" value="<?php echo $categoryRowset['company_name'];?>" name="cname" required>
														
													</div>
												</div>
                                                                                            <div class="form-group">
													<label class="col-md-3 control-label">Company Reg Id</label>
													<div class="col-md-4">
														<input type="text" class="form-control" placeholder="Enter text" value="<?php echo $categoryRowset['company_id'];?>" name="cid" required>
										...
										<div class="col-md-4">
											<div class="input-group date date-picker" data-date-format="dd-mm-yyyy">
												...
												<div class="form-group">
													...
													<div class="col-md-2">
														<input type="file" name="image" class=" btn blue"  ><?php if($categoryRowset['image']!=''){?><br><a href="../upload/userimage/<?php echo $categoryRowset['image'];?>" target="_blank">View</a><?php }?>

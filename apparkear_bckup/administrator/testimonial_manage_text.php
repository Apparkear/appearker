...
if (isset($_REQUEST['submit'])) {
    ...
    $testimonial_manage_text = isset($_POST['testimonial_manage_text']) ? $_POST['testimonial_manage_text'] : '';




    $fields = array(
        'testimonial_manage_text' => mysql_real_escape_string($testimonial_manage_text)
    );
    ...
    if (mysql_query($editQuery)) {
        ...
        header('Location:testimonial_manage_text.php');
        exit();
    }
}
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!-- BEGIN PAGE HEADER-->
            <h3 class="page-title">
                Testimonial Text <small><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Testimonial Text</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="list_product.php">Checked Home Text</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <span><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Testimonial Text</span>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Testimonial Text
                            </div>
                            <!--<div class="tools">
                            ...
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="testimonial_manage_text" value="<?php echo $categoryRowset['testimonial_manage_text'] ?>" class="form-control" placeholder="Testimonial Manage Text.">

...
if (isset($_GET['action']) && $_GET['action'] == 'delete') {
    $item_id = $_GET['cid'];
    mysqli_query($link, "delete from `car_type_size` where id='" . $item_id . "'");
...
<script language="javascript">
    function del(aa, bb) {
        ...
        if (a) {
            location.href = "amenities-list.php?cid=" + aa + "&action=delete"
        }
    }
        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="search_user.php">List Amenities</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                </ul>
                                    ...
                                    if (mysqli_num_rows($record) == 0) {
                                        ...
                                        while ($row = mysqli_fetch_object($record)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-info btn-sm" onClick="window.location.href = 'car-type-size-add.php?id=<?php echo $row->id ?>&action=edit'"><i class="fa fa-pencil"></i></a>

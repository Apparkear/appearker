...
if (isset($_REQUEST['submit'])) {
    ...
    $fields = array(
        'makes_id' =>mysqli_real_escape_string($link, $makes_id),
...
if ($_REQUEST['action'] == 'edit') {
    $categoryRowset = mysqli_fetch_array(mysqli_query($link, "SELECT * FROM `carmodels` WHERE `id`='" . mysqli_real_escape_string($link, $_REQUEST['id']) . "'"));
}
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!-- BEGIN PAGE HEADER-->
            <h3 class="page-title">
                Pages<small><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Models</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="add_model.php">Model</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <span><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Models</span>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Add Models
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form class="form-horizontal" method="post" action="add_model.php" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="<?php echo $_REQUEST['id']; ?>" />
                                <input type="hidden" name="action" value="<?php echo $_REQUEST['action']; ?>" />

                                    <div class="form-group" style="padding-top: 2%;">
                                        <label class="col-md-3 control-label">Select Make</label>
                                        <div class="col-md-4">
                                            <select id="selectError" name="makes_id">
                                                ...
                                                {
                                                ?>
                                                <option value="<?php echo $row1['id']; ?>" <?php if($categoryRowset['makes_id']==$row1['id']) { echo "selected";}?> > <?php echo $row1['name']; ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                         <input type="checkbox" <?php if($categoryRowset['status']==1){ ?>checked<?php } ?> name="status" class="form-control" value="1" >
                                ...
                                <div class="form-actions fluid">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <button type="button" class="btn default" onclick="location.href = 'list_model.php'">Cancel</button>
                                        </div>
                                    </div>
                                </div>
                            </form>

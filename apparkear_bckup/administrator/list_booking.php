                    ...
                    <div class="portlet box blue">
				       ...
				       <th>Discount</th>
                                ...
                                <tbody>
                                    <?php
				    $i=1;
                                    $fetch_product = mysqli_query($link, "select * from estejmam_booking ORDER BY id DESC");
				       ...
				       <td><? echo (($product['price']+$product['service_charge']) - $product['total_price']);?></td>
                                        ...
                                        <td><?php if($product['payment_type']=='BT'){ echo 'Braintree'; }
                                                  if($product['payment_type']=='PP'){ echo 'PayPal Pro'; }else if($product['payment_type']=='stripe'){echo 'stripe';}
                                        ?></td>
                                        <td><?php

...
$categoryRowset = mysql_fetch_array(mysql_query("SELECT * FROM `estejmam_store` WHERE `id`='".mysql_real_escape_string($_REQUEST['id'])."'"));
				...
				<div class="col-md-12">
					<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i> Store Details
										</div>
										<div class="tools">
                                     ...
                                     <input type="hidden" name="action" value="<?php echo $_REQUEST['action'];?>" />
											...
											<div class="form-body">
												<div class="form-group">
													<label class="col-md-3 control-label">Verification Code:</label>
													<div class="col-md-4">  <?php echo $categoryRowset['store_auto_id'];?> 
												...
												<div class="form-group">
													...
													<div class="col-md-4">   <?php echo $categoryRowset['store_title'];?> 
											...
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-4">  <?php echo  $categoryRowset['address'];?>
												...
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
														<!--<button type="submit" class="btn blue"  name="submit">Submit</button>-->
														 <a href="javascript:window.print();">Print the details</a>
													</div>
												</div>
											</div>
										...
										<div class="col-md-4">
											...
											<div class="form-actions fluid">
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
														<!--<button type="submit" class="btn blue"  name="submit">Submit</button>-->
														<button type="reset" class="btn blue" onClick="window.location.href='list_not_verified_store.php'">Back</button>
													</div>
												</div>
											</div>
										</form>

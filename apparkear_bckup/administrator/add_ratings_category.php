...
if ($_REQUEST['action'] == 'edit') {
      ...
      $categoryRowset = mysqli_fetch_assoc(mysqli_query($link, "SELECT * FROM `ratings_category` WHERE `id`='" . mysqli_real_escape_string($link, $_REQUEST['id']) . "'"));
        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">Ratings Category</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <span><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Ratings Category</span>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Ratings Category
                            </div>
                        </div>

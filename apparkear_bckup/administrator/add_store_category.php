				...
				<div class="col-md-12">
					<div class="portlet box blue">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="#" class="form-horizontal" method="post" action="add_store_category.php" enctype="multipart/form-data">
											...
											<div class="form-actions fluid">
												<div class="row">
													<div class="col-md-offset-3 col-md-9">
														...
														<button type="button" class="btn default" onClick="location.href='list_store_category.php'">Cancel</button>
													</div>
												</div>
											</div>
										</form>

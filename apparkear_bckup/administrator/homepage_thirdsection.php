...
if ((!isset($_REQUEST['submit'])) && (!isset($_REQUEST['action']))) {
    ...
    $sql = "select * from `homepage_thirdsection`  where id<>''";
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!-- BEGIN PAGE HEADER-->
            <h3 class="page-title">
                List of Homepage Third Section
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="list_banner.php">List Homepage Third Section</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <!--<li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-edit"></i>Homepage Third Section
                            </div>
                            <!--<div class="tools">
                                        ...
                                        while ($row = mysql_fetch_object($record)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-info btn-sm" onClick="window.location.href = 'edit_thirdsection.php?id=<?php echo $row->id ?>&action=edit'"><i class="fa fa-pencil"></i></a>

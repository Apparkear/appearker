...
<section class="help-box container">
    <div class="row py-5">
        ...
        <div class="col-md-6 renter" data-toggle="collapse" data-target="#Renter" id="rentertab" style="cursor:pointer;">
            <div class="help-bg p-4 text-center my-3">
                <h4 class="active-text">Renter</h4>
            </div>
        </div>

        <div class="col-md-6 owner" data-toggle="collapse" data-target="#Owner" id="ownertab" style="cursor:pointer;">
            <div class="help-bg p-4 text-center my-3">
        ...
        <div class="col-md-12 renterpage collapse" id="Renter">
            <div class="help-bg p-4 text-center my-3">
                <div class="accordion text-left" id="accordionExample1">
                  <?php
                  $number = 1;

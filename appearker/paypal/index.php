        ...
        <tr>
            ...
            <td width="30%">
                <form method="post" action="process.php?paypal=checkout">
                    <input type="text" name="itemname" value="Canon EOS Rebel XS" /> 
                    <input type="text" name="itemnumber" value="10000" /> 
                    <input type="text" name="itemdesc" value="Capture all your special moments with the Canon EOS Rebel XS/1000D DSLR camera and cherish the memories over and over again." /> 
                    <input type="text" name="itemprice" value="225.00" />

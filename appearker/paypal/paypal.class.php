...
class MyPayPal {
    ...
    function SetExpressCheckout($products, $charges, $noshipping = '1') {
        ...
        $_SESSION['ppl_last_id'] = $_SESSION['last_id'];
        $_SESSION['ppl_property_id'] = $_SESSION['property_id'];
        ...
        if (!empty($_SESSION['ppl_products']) && !empty($_SESSION['ppl_charges'])) {
            ...
            if ("SUCCESS" == strtoupper($httpParsedResponseAr["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($httpParsedResponseAr["ACK"])) {
                ...
                if ('Completed' == $httpParsedResponseAr["PAYMENTINFO_0_PAYMENTSTATUS"]) {
                    $_SESSION['paypalpaymentcomplate']="PaymentOk";
                    $_SESSION['paymenthash']=md5("PaymentOk:".$httpParsedResponseAr["PAYMENTINFO_0_TRANSACTIONID"]);
                    $_SESSION['transictionid']=$httpParsedResponseAr["PAYMENTINFO_0_TRANSACTIONID"];
    ...
    function GetTransactionDetails() {
        ...
        if ("SUCCESS" == strtoupper($httpParsedResponseAr["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($httpParsedResponseAr["ACK"])) {
            ...
            $_SESSION['ppl_txn_id'] = $httpParsedResponseAr['TRANSACTIONID'];
            
            header('location: success.php');
            exit();
            
            // echo '<br /><b>Stuff to store in database :</b><br /><pre>';
            // echo $_SESSION['ppl_last_id'];
            // echo $_SESSION['ppl_property_id'];

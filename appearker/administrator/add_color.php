...
//print_r($fields); exit;
    ...
    if ($_REQUEST['action'] == 'edit') {
        ...
        $editQuery = "UPDATE `colors` SET " . implode(', ', $fieldsList)
        ...
        $addQuery = "INSERT INTO `colors` (`" . implode('`,`', array_keys($fields)) . "`)"
...
if ($_REQUEST['action'] == 'edit') {
    $categoryRowset = mysqli_fetch_array(mysqli_query($link, "SELECT * FROM `colors` WHERE `id`='" . mysqli_real_escape_string($link, $_REQUEST['id']) . "'"));
}
...
if (isset($_REQUEST['bulk_delete_submit'])) {
    ...
    foreach ($idArr as $id) {
        mysqli_query($link, "DELETE FROM `colors` WHERE id=" . $id);
    }
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!-- BEGIN PAGE HEADER-->
            <h3 class="page-title">
                Color <small><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Color</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="add_color.php">Color</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <span><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Color</span>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Add Color
                            </div>
                        </div>
                                ...
                                <div class="form-actions fluid">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <button type="button" class="btn default" onclick="location.href = 'list_color.php'">Cancel</button>
                                        </div>
                                    </div>
                                </div>
                            </form>

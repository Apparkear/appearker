...
if ((!isset($_REQUEST['submit'])) && (!isset($_REQUEST['action']))) {
    ...
    $sql = "select * from estejmam_banner  where id<>''";
...
if (isset($_REQUEST['submit'])) {
    ...
    $des_trans = isset($_POST['des_trans']) ? $_POST['des_trans'] : '';


    $fields = array(
        'name' => mysqli_real_escape_string($link, $name),
        'description' => mysqli_real_escape_string($link, $description),
        'des_trans' => mysqli_real_escape_string($link, $des_trans),
    );
    ...
    if ($_REQUEST['action'] == 'edit') {
        ...
        if ($_FILES['image']['tmp_name'] != '') {
            ...
            $image = mysqli_query($link, "UPDATE `estejmam_banner` SET `image`='" . $img_name . "' WHERE `id` = '" . mysqli_real_escape_string($link, $_REQUEST['id']) . "'");
        }
        ...
        if (in_array($fileParts['extension'], $fileTypes)) {
            ...
            if ($_FILES['image']['tmp_name'] != '') {
                ...
                $image = mysqli_query($link, "UPDATE `estejmam_banner` SET `image`='" . $img_name . "' WHERE `id` = '" . $last_id . "'");
            }
            header('Location:list_banner.php');
            exit();
        } else {
...
if ($_REQUEST['action'] == 'edit') {
    $categoryRowset = mysqli_fetch_array(mysqli_query($link, "SELECT * FROM `estejmam_banner` WHERE `id`='" . mysqli_real_escape_string($link, $_REQUEST['id']) . "'"));
}
...
if (isset($_REQUEST['bulk_delete_submit'])) {
    ...
    foreach ($idArr as $id) {
        mysqli_query($link, "DELETE FROM`estejmam_banner` WHERE id=" . $id);
    }
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="des_trans" class="form-control" value="<?php echo $categoryRowset['des_trans']; ?>" placeholder="Enter Information">
                                        </div>
                                    </div>
                                ...
                                <div class="form-actions fluid">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <button type="button" class="btn default" onclick="location.href = 'list_banner.php'">Cancel</button>
                                        </div>
                                    </div>
                                </div>
                            </form>

...
if (isset($_GET['action']) && $_GET['action'] == 'delete') {
    ...
    header('Location:search_user_host.php');
    exit();
}
...
if (isset($_POST['ExportCsv'])) {
    ...
    $sql = "select * from estejmam_user where id<>'' AND `host_type`='1'";
...
<script language="javascript">
    function del(aa, bb)
    {
        ...
        if (a)
        {
            location.href = "search_user_host.php?cid=" + aa + "&action=delete"
        }
    }

    function inactive(aa)
    {
        location.href = "search_user_host.php?cid=" + aa + "&action=inactive"

    }
    function active(aa)
    {
        location.href = "search_user_host.php?cid=" + aa + "&action=active";
    }

    function inactiveVar(aa)
    {
        location.href = "search_user_host.php?cid=" + aa + "&action=notverify"

    }
    function activeVar(aa)
    {
        location.href = "search_user_host.php?cid=" + aa + "&action=verify";
    }

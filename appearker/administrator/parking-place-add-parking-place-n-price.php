...
if (isset($_POST['submit'])) {
    ...
    $_SESSION['parking_place']['place_price'] = [
        'street_1' => $_POST['street_1'],
        'intersection' => $_POST['intersection'],
        'number' => $_POST['number'],
        'building_name' => $_POST['building_name'],
        'parking_lot_no' => $_POST['parking_lot_no'],
        'currency' => $_POST['currency'],
        'min_monthly_price' => $_POST['min_monthly_price'],
        'max_monthly_price' => $_POST['max_monthly_price'],
        'dynamic_price' => $_POST['dynamic_price'],
        'discount' => $_POST['discount'],
        'keys' => $_POST['keys'],
        'keys_price' => $_POST['keys_price'],
        'access_card' => $_POST['access_card'],
        'access_card_price' => $_POST['access_card_price'],
        'remote_control' => $_POST['remote_control'],
        'remote_control_price' => $_POST['remote_control_price'],
        'insurance_agreement' => $_POST['insurance_agreement'],
        'insurance_agreement_price' => $_POST['insurance_agreement_price']
    ];

    header('location: parking-place-add-reservation-n-time-preferences.php');
    exit();
}
                                ...
                                <div class="form-body">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="street_1" class="form-control" value="" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Intersection:</label>
                                            <div class="col-md-4">
                                                <input type="text" name="intersection" class="form-control" value="" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="building_name" class="form-control" value="" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Parking Lot No:</label>
                                            <div class="col-md-4">
                                                <input type="text" name="parking_lot_no" class="form-control" value="" required>
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="min_monthly_price" class="form-control" value="" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    <span class="input-group-addon">$</span>
                                                    <input type="text" name="max_monthly_price" class="form-control" value="" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="keys_price" class="form-control" value="" required>
                                                    <span class="input-group-addon">$</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="access_card_price" class="form-control" value="" required>
                                                    <span class="input-group-addon">$</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="remote_control_price" class="form-control" value="" required>
                                                    <span class="input-group-addon">$</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="insurance_agreement_price" class="form-control" value="" required>
                                                    <span class="input-group-addon">$</span>
                                                </div>
                                            </div>
                                        </div>

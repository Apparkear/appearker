        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="caption">
                        <i class="fa fa-user"></i> Total Rentee
                        : <?php echo $numLandlord; ?>
                    </div>
                    <table class="table">
                        <thead>
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php
$book = mysqli_query($link, "select * from `estejmam_booking` where 1 order by `date` DESC");
$num_all = mysqlI_num_rows($book);
if ($num_all > 0) {
    while ($allbooks = mysqli_fetch_array($book)) {
        $prop_name = mysqli_fetch_array(mysqli_query($link, "select * from `estejmam_main_property` where `id`='" . $allbooks['prop_id'] . "'"));
                ...
                <div class="col-md-12 col-sm-6">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title line">
                            <div class="caption">
                                <i class="fa fa-bell-o"></i>Recent Rentee
                            </div>
                            <!--                            <div class="tools">
                                    ...
                                    <div class="tab-pane active" id="tab_1_1">
                                        <div class="scroller" style="height: 290px;" data-always-visible="1" data-rail-visible1="1">
                                            <div class="row">
                                                ...
                                                <?php
$queryOnlineVendor = "SELECT * from estejmam_user where  `type`='2' order by `id` DESC LIMIT 8";
    ...
    ?>
                                                    ...
                                                    <div class="col-md-6 user-info">
                                                        ...
                                                        <div class="details">
                                                            ...
                                                            <!--                                                            <div>
                                                                                                                            IP : <?php echo $dataOnlineVendor['ip']; ?>
                                                                                                                        </div>-->
                                                            <div>
                                    ...
                                    <div class="tab-pane active" id="tab_1_1">
                                        <div class="scroller" style="height: 290px;" data-always-visible="1" data-rail-visible1="1">
                                            <div class="row">
                                                ...
                                                <?php
$queryOnlineVendor = "SELECT * from estejmam_user where `type`='1'  order by `id` DESC LIMIT 8";
$resOnlineVendor = mysqli_query($link, $queryOnlineVendor);
$numOnlineVendor = mysqlI_num_rows($resOnlineVendor);
while ($dataOnlineVendor = mysqlI_fetch_assoc($resOnlineVendor)) {

...
if (isset($_REQUEST['submit'])) {
    ...
    $check_home_text = isset($_POST['check_home_text']) ? $_POST['check_home_text'] : '';




    $fields = array(
        'check_home_text' => mysql_real_escape_string($check_home_text)
    );
    ...
    if (mysql_query($editQuery)) {
        ...
        header('Location:check_home_manage_text.php');
        exit();
    }
}
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!-- BEGIN PAGE HEADER-->
            <h3 class="page-title">
                Checked Home <small><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Checked Home</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <span><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Checked Home Text</span>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Checked Home Text
                            </div>
                            <!--<div class="tools">
                            ...
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="check_home_text" value="<?php echo $categoryRowset['check_home_text'] ?>" class="form-control" placeholder="Checked Home Text.">

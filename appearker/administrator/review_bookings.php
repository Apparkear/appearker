        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="review_bookings.php"> In Review Booking list</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <!--<li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
					 ...
					 <th>Discount</th>
                                ...
                                <tbody>
                                    <?php
$fetch_product = mysqli_query($link, "select * from estejmam_booking where `status`='0' ORDER BY id DESC");
    ...
    function disputeBooking(id){
        ...
        $.ajax({
            ...
            success:function(data){
                if(data.ack==1){
                    alert(data.res);
                    window.location.href='disputed_bookings.php';
                }
                if(data.ack==0){
                    alert(data.res);
                }

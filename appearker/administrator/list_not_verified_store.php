<?php
include_once("controller/unverifiedStoreController.php");
...
<script language="javascript">
   function del(aa,bb)
   {
      ...
      if (a)
      {
        location.href="list_not_verified_store.php?cid="+ aa +"&action=delete"
      }  
   } 
   
function inactive(aa)
   { 
       location.href="list_not_verified_store.php?cid="+ aa +"&action=inactive"

   } 
   function active(aa)
   {
     location.href="list_not_verified_store_store.php?cid="+aa+"&action=active";
   } 
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
				...
				<h3 class="page-title">
			Store <small>List Unverified Store</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<span>List Unverified Store</span>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>List Unverified Store
							</div>
							<div class="tools">
...
<!--									<div class="col-md-6">
		    ...
		    ?>
							...
							<tr>
                                                             ...
                                                             <td><?php echo stripslashes($row->new_store_id);?></td>
								<td><?php echo stripslashes($row->store_auto_id);?></td>
								...
								<td><?php echo stripslashes($package_name->name);?></td>
								...
								<td>
                                                                    <a href="print_store.php?id=<?php echo $row->id ?>&action=details">Print</a><br>		
                                                                <a href="details_store_nonv.php?id=<?php echo $row->id ?>&action=details">Details</a>		
...
function deleteConfirm(){
    var result = confirm("Are you sure to delete NOt Varified Store?");
    if(result){
        return true;
    }else{
        return false;

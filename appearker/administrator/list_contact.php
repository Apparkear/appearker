...
if (isset($_GET['action']) && $_GET['action'] == 'delete') {
    $item_id = $_GET['cid'];
    mysqli_query($link, "delete from estagemum_contact_details where id='" . $item_id . "'");
...
if ((!isset($_REQUEST['submit'])) && (!isset($_REQUEST['action']))) {
    ...
    $sql = "select * from estagemum_contact_details where id<>''";
...
<script language="javascript">
    function del(aa, bb)
    {
        ...
        if (a)
        {
            location.href = "list_contact.php?cid=" + aa + "&action=delete"
        }
    }
</script>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-edit"></i>List Contact Us
                            </div>
                            <!--<div class="tools">
                                    ...
                                    if (mysqli_num_rows($record) == 0) {
                                        ...
                                        while ($row = mysqli_fetch_object($record)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo stripslashes($row->phone); ?>
                                                </td>

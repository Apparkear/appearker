...
if(isset($_REQUEST['submit']))
{
	...
	$fields = array(
	 ...
	 if($_REQUEST['action']=='edit')
	  {		  
	  $editQuery = "UPDATE `estejmam_new_shipping_address` SET " . implode(', ', $fieldsList)
		...
		$image =mysql_query("UPDATE `estejmam_new_shipping_address` SET `image`='".$img_name."' WHERE `id` = '" . mysql_real_escape_string($_REQUEST['id']) . "'");
		}
	 ...
	 else
	 {
	  ...
	  $addQuery = "INSERT INTO `estejmam_new_shipping_address` (`" . implode('`,`', array_keys($fields)) . "`)"
		...
		$image =mysql_query("UPDATE `estejmam_new_shipping_address` SET `image`='".$img_name."' WHERE `id` = '" . $last_id . "'");
		}
...
if($_REQUEST['action']=='edit')
{
$categoryRowset = mysql_fetch_array(mysql_query("SELECT * FROM `estejmam_new_shipping_address` WHERE `user_id`='".mysql_real_escape_string($_REQUEST['id'])."'"));
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<span><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Shipping Details</span>
					</li>
				</ul>
				...
				<div class="col-md-12">
					<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i><?php echo $_REQUEST['action']=='edit'?"Edit":"Add";?> Shipping Details
										</div>
										<!--<div class="tools">

...
//print_r($fields); exit;
    ...
    if ($_REQUEST['action'] == 'edit') {
        ...
        $editQuery = "UPDATE `makes` SET " . implode(', ', $fieldsList)
        . " WHERE `id` = '" . mysqli_real_escape_string($link, $_REQUEST['id']) . "'";

        mysqli_query($link, $editQuery);

        
        header('Location:list_make.php');
        exit();
    } else {

        $addQuery = "INSERT INTO `makes` (`" . implode('`,`', array_keys($fields)) . "`)"
...
if ($_REQUEST['action'] == 'edit') {
    $categoryRowset = mysqli_fetch_array(mysqli_query($link, "SELECT * FROM `makes` WHERE `id`='" . mysqli_real_escape_string($link, $_REQUEST['id']) . "'"));
}
...
if (isset($_REQUEST['bulk_delete_submit'])) {
    ...
    foreach ($idArr as $id) {
        mysqli_query($link, "DELETE FROM `makes` WHERE id=" . $id);
    }
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!-- BEGIN PAGE HEADER-->
            <h3 class="page-title">
                Make <small><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Make</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="add_banner.php">Make</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <span><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Make</span>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Add Make
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form class="form-horizontal" method="post" action="add_make.php" enctype="multipart/form-data">
                                ...
                                <div class="form-actions fluid">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <button type="button" class="btn default" onclick="location.href = 'list_make.php'">Cancel</button>
                                        </div>
                                    </div>
                                </div>
                            </form>

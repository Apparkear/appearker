        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">List Apartment Feature</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <!--<li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-edit"></i>List Apartment Feature
                            </div>
                            <div class="tools">
                                    ...
                                    if (mysqli_num_rows($record) == 0) {
                                        ...
                                        while ($row = mysqli_fetch_object($record)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a onClick="window.location.href = 'add_apartment_feature.php?id=<?php echo $row->id ?>&action=edit'">Edit</a>
                                                </td>
                                                <td>

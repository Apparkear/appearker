...
?>
<?php
    $sql = "select * from estejmam_booking  where status='0'";
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-edit"></i>List Failed Payments
                            </div>
                           <div class="tools">
...
$userDetails=mysql_fetch_object(mysql_query("SELECT * FROM `estejmam_user` WHERE `id`='".$row->user_id."'"));
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="javascript:void(0);" class="btn btn-mini red">
                                                        Failed </a>
                                                </td>
                                            </tr>
                                            <?php

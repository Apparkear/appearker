...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			News Letter <small><?php echo $_REQUEST['action']=='edit'?"Send":"Send";?> News Letter</small>
			</h3>
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="send_news.php">News Letter</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<span><?php echo $_REQUEST['action']=='edit'?"Send":"Send";?> News Letter</span>
					</li>
				</ul>
				...
				<div class="col-md-12">
					<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Send News Letter
										</div>
										<div class="tools">
									...
									<div class="portlet-body form">
                                     ...
                                     <input type="hidden" name="action" value="<?php echo $_REQUEST['action'];?>" />
											...
											<div class="form-body">
												...
												<div class="checkbox">
												<label>
												<input type="checkbox" id="sel_user"  value="1"> All Selected User</label>
												</div>
												</div>
												</div>
										...
										<div class="col-md-9">
											<select class="form-control" multiple="" name="email[]"  id="selectError">
													<?php 
												...
												<div class="col-md-9">
												<textarea class="ckeditor form-control" id="editor1" name="description" rows="6"></textarea>
												</div>
												</div>

...
<script language="javascript">
   function del(aa,bb)
   {
      ...
      if (a)
      {
        location.href="list_classified.php?cid="+ aa +"&action=delete"
      }  
   } 
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="#">List Classified Category</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<!--<li>
...
<!--									<div class="col-md-6">
							...
							<tbody>
							<?php
                                                // $sql="select * from estejmam_classified  where id<>''";
...
?>
							...
							<tr>
								...
								<td>
									<a  href="add_classified.php?id=<?php echo $row->id ?>&action=edit">
									Edit </a>
								</td>
								<td>

				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>List Amenities
							</div>
							<div class="tools">
...
$count=1;
	...
	{
            $cat=mysql_query("select * from `estejmam_product` where `cat_id`='".$row->id."'");
...
?>
							...
							<tr>
								...
								<td>
									<a onClick="window.location.href='add_category.php?id=<?php echo $row->id ?>&action=edit'">Edit</a>
								</td>
                                                                <td>

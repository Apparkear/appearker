<?php 
include_once("controller/NewVendorController.php");
?>
<script language="javascript">
   function del(aa,bb)
   {
      ...
      if (a)
      {
        location.href="new_vendor.php?cid="+ aa +"&action=delete"
      }  
   } 
   
   function active(aa)
   {
     location.href="new_vendor.php?cid="+aa+"&action=active";
   } 
							...
							<tr>
								...
								<!--<td>
									...
									<a onClick="javascript:del('<?php echo $row->id; ?>')">Delete</a>
                                                                ...
                                                                <td>
									<a href="new_vendor_details.php?id=<?php echo $row->id ?>&action=details">New Store Owner Details</a>
								</td>
                                                                 <td>
									<?php if($row->status=='2'){?>
<a onClick="javascript:active('<?php echo $row->id;?>');">Activate</a>
<?php } else {?>
<!--<button class="btn btn-mini"  onClick="javascript:inactive('<?php echo $row->id;?>');">Block</button>-->
		  <?php }?>
								</td>
...
function deleteConfirm(){
    var result = confirm("Are you sure to delete New Vendor?");
    if(result){
        return true;
    }else{
        return false;

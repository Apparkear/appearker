...
if (isset($_REQUEST['submit'])) {
    ...
    $care_about_title = isset($_POST['care_about_title']) ? $_POST['care_about_title'] : '';
    $care_about_desc = isset($_POST['care_about_desc']) ? $_POST['care_about_desc'] : '';
    $care_about_button_text = isset($_POST['care_about_button_text']) ? $_POST['care_about_button_text'] : '';
    ...
    if (mysqli_query($link, $editQuery)) {
        ...
        header('Location:care_about_manage_text.php');
        exit();
    }
}
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!-- BEGIN PAGE HEADER-->
            <h3 class="page-title">
                Care About <small><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Care About Text</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="list_product.php">Care About Text</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <span><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Care About Text</span>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Care About Text
                            </div>
                            <!--<div class="tools">
                            ...
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="care_about_title" value="<?php echo $categoryRowset['care_about_title'] ?>" class="form-control" placeholder="Care About Title.">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <textarea name="care_about_desc" class="form-control" placeholder="Care About Description."><?php echo $categoryRowset['care_about_desc'] ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="care_about_button_text" value="<?php echo $categoryRowset['care_about_button_text'] ?>" class="form-control" placeholder="Care About Button Text.">

...
<?php
	$today=date('Y-m-d');
	$sql = "select * from estejmam_booking  where end_date <'".$today."'";
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-edit"></i>List Expired Booking
                            </div>
                            <div class="tools">

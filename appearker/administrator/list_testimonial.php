...
if (isset($_GET['action']) && $_GET['action'] == 'delete') {
    $item_id = $_GET['cid'];
    mysqli_query($link, "delete from estejmam_testimonials where id='" . $item_id . "'");
...
<script language="javascript">
    function del(aa, bb)
    {
        ...
        if (a)
        {
            location.href = "list_testimonial.php?cid=" + aa + "&action=delete"
        }
    }
</script>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-edit"></i>List Testimonial
                            </div>
                            <!--<div class="tools">
                            ...
                            <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo stripslashes($row->user_name); ?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a  href="add_testimonial.php?id=<?php echo $row->id ?>&action=edit">
                                                Edit </a>

                                            <a class="delete" href="javascript:;" onclick="del('<?php echo $row->id ?>')">
                                                Delete </a>
                                        </td>
                                    </tr>
                                    <?php

...
if (isset($_POST['submit'])) {
    $updateQry = mysqli_query($link, "UPDATE `parking_places` SET `title`='{$_POST['title']}', `about`='{$_POST['about']}', `rules_availability` = '{$_POST['rules_availability']}' WHERE `id` = '{$_REQUEST['id']}'");

    header('location: parking-place-edit-parking-place-n-price.php?id='.$_REQUEST['id']);
    exit();
}
                            ...
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="title" class="form-control" value="<?php echo $editObj->title; ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">About This Listing:</label>
                                        <div class="col-md-4">
                                            <textarea name="about" class="form-control" required><?php echo $editObj->about; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Rules and Availability Days/Hours:</label>
                                        <div class="col-md-4">
                                            <textarea name="rules_availability" class="form-control" required><?php echo $editObj->rules_availability; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">

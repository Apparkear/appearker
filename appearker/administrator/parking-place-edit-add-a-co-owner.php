...
if (isset($_POST['submit'])) {
    ...
    $updateQry = mysqli_query($link, "UPDATE `parking_places` SET `co_owner_fname`='{$_POST['co_owner_fname']}', `co_owner_lname`='{$_POST['co_owner_lname']}', `co_owner_address` = '{$_POST['co_owner_address']}', `co_owner_email` = '{$_POST['co_owner_email']}', `co_owner_mobile_phone` = '{$_POST['co_owner_mobile_phone']}'  WHERE `id` = '{$_REQUEST['id']}'");
                            ...
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="co_owner_fname" class="form-control" value="<?php echo $editObj->co_owner_fname; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="co_owner_lname" class="form-control" value="<?php echo $editObj->co_owner_lname; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="co_owner_address" class="form-control" value="<?php echo $editObj->co_owner_address; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="email" name="co_owner_email" class="form-control" value="<?php echo $editObj->co_owner_email; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="co_owner_mobile_phone" class="form-control" value="<?php echo $editObj->co_owner_mobile_phone; ?>" required>
                                        </div>
                                    </div>

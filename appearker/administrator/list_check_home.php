        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="list_banner.php">View Home Check Section</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <!--<li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-edit"></i>List Home Check Section
                            </div>
                            <!--<div class="tools">
                                    ...
                                    if (mysql_num_rows($record) == 0) {
                                        ...
                                        while ($row = mysql_fetch_object($record)) {
                                            if ($row->background_image == '') {
                                                ...
                                                $img = '../upload/homecheck/' . $row->background_image;
                                            }
                                            ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-info btn-sm" onClick="window.location.href = 'add_check_home.php?id=<?php echo $row->id ?>&action=edit'"><i class="fa fa-pencil"></i></a>

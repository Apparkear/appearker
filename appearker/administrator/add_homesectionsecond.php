...
if (isset($_REQUEST['submit'])) {
    ...
    if ($_REQUEST['action'] == 'edit') {
        ...
        if ($_FILES['image']['tmp_name'] != '') {
            ...
            $image = mysqli_query($link, "UPDATE `home_section_second` SET `image`='" . $img_name . "' WHERE `id` = '" . mysqli_real_escape_string($link, $_REQUEST['id']) . "'");
        }
        ...
        if (in_array($fileParts['extension'], $fileTypes)) {
            ...
            $_SESSION['MSG'] = 1;
            header('Location:add_homesectionsecond.php');
            exit();
        }
    }
}
...
if ($_REQUEST['action'] == 'edit') {
    $categoryRowset = mysqli_fetch_array(mysqli_query($link, "SELECT * FROM `home_section_second` WHERE `id`='" . mysqli_real_escape_string($link, $_REQUEST['id']) . "'"));
}
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!-- BEGIN PAGE HEADER-->
            <h3 class="page-title">
                Space <small><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Space</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="add_homesection.php">Space</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <li>
                        <span><?php echo $_REQUEST['action'] == 'edit' ? "Edit" : "Add"; ?> Space</span>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Add Space
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form class="form-horizontal" method="post" action="add_homesectionsecond.php" enctype="multipart/form-data">
                                ...
                                <div class="form-actions fluid">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <button type="button" class="btn default" onclick="location.href = 'list_homesectionsecond.php'">Cancel</button>
                                        </div>
                                    </div>
                                </div>
                            </form>

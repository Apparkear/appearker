...
function arrayToMysql($arr) {
    foreach ($arr as $key => $value) {
        if (is_array($value)) {
            $fields[] = sprintf("`%s` = '%s'", $key, implode(',', $value));
        } else {
...
if (isset($_POST['submit'])) {
    $_SESSION['parking_place']['co_owner'] = [
        'co_owner_fname' => $_POST['co_owner_fname'],
        'co_owner_lname' => $_POST['co_owner_lname'],
        'co_owner_address' => $_POST['co_owner_address'],
        'co_owner_email' => $_POST['co_owner_email'],
        'co_owner_mobile_phone' => $_POST['co_owner_mobile_phone']
    ];

    $sql = "INSERT INTO `parking_places` SET "
            . arrayToMysql($_SESSION['parking_place']['general_information']) .", "
            . arrayToMysql($_SESSION['parking_place']['contact_information']) .", "
            . arrayToMysql($_SESSION['parking_place']['property_description']) .", "
            . arrayToMysql($_SESSION['parking_place']['place_price']) .", "
            . arrayToMysql($_SESSION['parking_place']['reservation_time_preference']) .", "
            . arrayToMysql($_SESSION['parking_place']['cancellation_refund_availibility']) .", "
            . arrayToMysql($_SESSION['parking_place']['co_owner']);

    mysqli_query($link, $sql);

    $lastID = mysqli_insert_id($link);
    if ($lastID) {
        unset($_SESSION['parking_place']);
                ...
                <div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Add a Co-owner
                            </div>
                        </div>
                            ...
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="co_owner_fname" class="form-control" value="" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="co_owner_lname" class="form-control" value="" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="co_owner_address" class="form-control" value="" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="email" name="co_owner_email" class="form-control" value="" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="co_owner_mobile_phone" class="form-control" value="" required>
                                        </div>
                                    </div>

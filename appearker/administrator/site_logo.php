...
if (isset($_REQUEST['submit'])) {
    ...
    if (mysqli_query($link, $editQuery)) {
        ...
        if ($_FILES['image']['tmp_name'] != '') {
            ...
            $image = mysqli_query($link, "UPDATE `estejmam_sitesettings` SET `sitelogo`='" . $img_name . "' WHERE `id` = '" . mysqli_real_escape_string($link, $_REQUEST['id']) . "'");
        } else {
...
<?php //include('includes/style_customize.php'); ?>
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="site_logo.php">Manage Logo</a>
                        <i class="fa fa-angle-right"></i>
                    </li>
                    <!--<li>
                ...
                <div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Manage Logo
                            </div>
                            <!--<div class="tools">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="#" class="form-horizontal" method="post" action="site_logo.php" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Alt Image Text</label>
                                        <div class="col-md-4">

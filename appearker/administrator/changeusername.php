...
// $in_user2=$_REQUEST['in_user2'];
    ...
    $fields = array('admin_username' => mysqli_real_escape_string($link, $in_user2));
                ...
                <div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Change Username
                            </div>
                            <!--<div class="tools">
                            ...
                            <form action="#" class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" placeholder="Enter user name"  value="<?php echo $row['admin_username']; ?>" name="in_user2" required>
                                ...
                                <div class="form-actions fluid">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <!--														<button type="button" class="btn default" onClick="location.href='changeusername.php'">Cancel</button>-->
                                        </div>
                                    </div>
                                </div>
                            </form>

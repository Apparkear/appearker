...
if (isset($_REQUEST['submit'])) {
    ...
    $fields = array('name' => mysqli_real_escape_string($link, $name),
        'description' => mysqli_real_escape_string($link, $description),
        'sms' => mysqli_real_escape_string($link, $sms),
                                ...
                                <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <textarea class="ckeditor form-control" id="editor2" name="sms" cols="100" rows="20"><?php echo stripslashes($row12['sms']); ?></textarea>
                                            </div>
                                        </div> -->

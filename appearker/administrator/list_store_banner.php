...
<!--									<div class="col-md-6">
							...
							<tbody>
							<?php
                                                  // $sql="select * from estejmam_banner_one  where id<>''";
...
?>
							...
							<tr>
								...
								<td>
									<a  href="add_store_banner.php?id=<?php echo $row->id ?>&action=edit">
									Edit </a>
								</td>
								<!--<td>
...
function deleteConfirm(){
    var result = confirm("Are you sure to delete Store banner?");
    if(result){
        return true;
    }else{
        return false;
